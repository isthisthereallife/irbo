class AboutUs {
  ...
  */
  ...
  render() {
    ...
    $('main').html(/*html*/`
      <section class="container mt-5 mb-3 data-aboutUs">
      <section class="row w-100">
        <img src="../images/snakeHome1.jfif">  
        <article class="col-lg-12 col-12 col-md-6 border border-primary rounded m-1">
          <h2>Om Snakebaby</h2>  
        ...
        <article class="col-lg-12 col-12 col-md-6 border border-primary rounded m-1">
        <img class="col-6 src="../images/snakeHome2.jfif">  
          <h3>
          ...
          <p>
            <strong>Välkommen till Snakebaby. Vi älskar ormar.</strong></p>  
        </article>
      </section>
    </section>
      `);
